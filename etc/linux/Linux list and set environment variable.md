...
MAILCHECK=60
OLDPWD=/root/code/java/xvideo-build
OPTERR=1
OPTIND=1
OSTYPE=linux-gnu
...
```bash
[root@virtual ~]# echo $PATH
/usr/local/sbin:/usr/local/bin:/sbin:/bin:/usr/sbin:/usr/bin:/root/bin
[root@virtual ~]# export PATH=$PATH:/root/tool/apache-maven-3.0.5/bin
[root@virtual ~]# echo $PATH
/usr/local/sbin:/usr/local/bin:/sbin:/bin:/usr/sbin:/usr/bin:/root/bin:/root/tool/apache-maven-3.0.5/bin
```
EOF